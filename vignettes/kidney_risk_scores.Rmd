...
htn | donor history of hypertension | numeric vector of values of 1 (yes) or 2 (no)
female | whether donor is female | numeric vector of values of 1 (yes) or 2 (no)
cmv | whether donor is CMV seropositive | numeric vector of values of 1 (yes) or 2 (no)
...
```{r, eval = F}
my_data3 = my_data2 %>%
  mutate(UKKDRI = ukkdri(age = Age, height = Height, htn = Hypertension,
                         female = Sex, cmv = CMV, gfr = eGFR, hdays = Hospital_Stay))
```
