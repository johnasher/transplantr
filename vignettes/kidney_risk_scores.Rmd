...
The raw EPTS score can be calculated using the `raw_epts()` function in the transplantr package, which takes the following parameters:
...
```{r}
epts_raw(age = 23.58, dm = 0, prev_tx = 1, dx = 5.0814511)
```
